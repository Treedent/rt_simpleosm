...
!function (t, i) {
    ...
    var fi, gi, vi, yi = i({}, pi, {
        ...
        Ti = B("webkit"), zi = B("android"), Mi = B("android 2") || B("android 3"),
        Ci = parseInt(/WebKit\/([0-9]+)|$/.exec(navigator.userAgent)[1], 10),
        Si = zi && B("Google") && Ci < 537 && !("AudioNode" in window), Zi = !!window.opera, Ei = B("chrome"),
        ki = B("gecko") && !Ti && !Zi && !Pi, Bi = !Ei && B("safari"), Ai = B("phantom"), Ii = "OTransition" in wi,
        ...
        Wi = "undefined" != typeof orientation || B("mobile"), Hi = Wi && Ti, Fi = Wi && Ni,
        ...
        Pe = (Object.freeze || Object)({
            ...
            panInside: function (t, i) {
                var e = w((i = i || {}).paddingTopLeft || i.padding || [0, 0]),
                    n = w(i.paddingBottomRight || i.padding || [0, 0]), o = this.getCenter(), s = this.project(o),
    ...
    var ke, Be = {Events: li}, Ae = qi ? "touchstart mousedown" : "mousedown",
